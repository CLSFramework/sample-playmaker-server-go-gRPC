...
const (
	ViewWidth_NARROW ViewWidth = 0 // Narrow view width (60 degrees).
	ViewWidth_NORMAL ViewWidth = 1 // Normal view width (90 degrees).
	ViewWidth_WIDE   ViewWidth = 2 // Wide view width (180 degrees).
)
...
const (
	InterceptActionType_UNKNOWN_Intercept_Action_Type InterceptActionType = 0 // Unknown intercept action type.
	InterceptActionType_OMNI_DASH                     InterceptActionType = 1 // Omni dash intercept action type. Means the agent will dash to the ball in any direction.
	InterceptActionType_TURN_FORWARD_DASH             InterceptActionType = 2 // Turn forward dash intercept action type. Means the agent will turn to the ball and dash to the ball.
	InterceptActionType_TURN_BACKWARD_DASH            InterceptActionType = 3 // Turn backward dash intercept action type. Means the agent will turn to the ball and dash to the ball in the backward direction.
)
...
type RpcVector2D struct {
	...
	X     float32 `protobuf:"fixed32,1,opt,name=x,proto3" json:"x,omitempty"`         // The x-coordinate of the vector.
	Y     float32 `protobuf:"fixed32,2,opt,name=y,proto3" json:"y,omitempty"`         // The y-coordinate of the vector.
	Dist  float32 `protobuf:"fixed32,3,opt,name=dist,proto3" json:"dist,omitempty"`   // The distance magnitude of the vector.
	Angle float32 `protobuf:"fixed32,4,opt,name=angle,proto3" json:"angle,omitempty"` // The angle of the vector in degrees. In soccer simulation 2D environment, the 0 degree is opponent's goal, and the angle increases in the counter-clock direction. So, if your team is in left side, -90 degree is up, 0 degree is right (opponent gole), 90 degree is down.
}
...
type RegisterRequest struct {
	...
	AgentType     AgentType `protobuf:"varint,1,opt,name=agent_type,json=agentType,proto3,enum=protos.AgentType" json:"agent_type,omitempty"` // The type of the agent. It can be PlayerT, CoachT, or TrainerT.
	TeamName      string    `protobuf:"bytes,2,opt,name=team_name,json=teamName,proto3" json:"team_name,omitempty"`                           // The name of the team that the agent belongs to.
	UniformNumber int32     `protobuf:"varint,3,opt,name=uniform_number,json=uniformNumber,proto3" json:"uniform_number,omitempty"`           // The uniform number of the agent.
	RpcVersion    int32     `protobuf:"varint,4,opt,name=rpc_version,json=rpcVersion,proto3" json:"rpc_version,omitempty"`                    // The version of the RPC protocol that the client supports.
}
...
type RegisterResponse struct {
	...
	ClientId              int32                 `protobuf:"varint,1,opt,name=client_id,json=clientId,proto3" json:"client_id,omitempty"`                                                                              // The unique identifier assigned to the client by the server.
	AgentType             AgentType             `protobuf:"varint,2,opt,name=agent_type,json=agentType,proto3,enum=protos.AgentType" json:"agent_type,omitempty"`                                                     // The type of the agent. It can be PlayerT, CoachT, or TrainerT.
	TeamName              string                `protobuf:"bytes,3,opt,name=team_name,json=teamName,proto3" json:"team_name,omitempty"`                                                                               // The name of the team that the agent belongs to.
	UniformNumber         int32                 `protobuf:"varint,4,opt,name=uniform_number,json=uniformNumber,proto3" json:"uniform_number,omitempty"`                                                               // The uniform number of the agent.
	RpcServerLanguageType RpcServerLanguageType `protobuf:"varint,5,opt,name=rpc_server_language_type,json=rpcServerLanguageType,proto3,enum=protos.RpcServerLanguageType" json:"rpc_server_language_type,omitempty"` // The language that the server is implemented in.
}
...
type Ball struct {
	...
	Position         *RpcVector2D `protobuf:"bytes,1,opt,name=position,proto3" json:"position,omitempty"`                                         // The position of the ball.
	RelativePosition *RpcVector2D `protobuf:"bytes,2,opt,name=relative_position,json=relativePosition,proto3" json:"relative_position,omitempty"` // The relative position of the ball to the agent who is sending the message.
	SeenPosition     *RpcVector2D `protobuf:"bytes,3,opt,name=seen_position,json=seenPosition,proto3" json:"seen_position,omitempty"`             // The position of the ball that the agent has seen.
	HeardPosition    *RpcVector2D `protobuf:"bytes,4,opt,name=heard_position,json=heardPosition,proto3" json:"heard_position,omitempty"`          // The position of the ball that the agent has heard.
	Velocity         *RpcVector2D `protobuf:"bytes,5,opt,name=velocity,proto3" json:"velocity,omitempty"`                                         // The velocity of the ball.
	SeenVelocity     *RpcVector2D `protobuf:"bytes,6,opt,name=seen_velocity,json=seenVelocity,proto3" json:"seen_velocity,omitempty"`             // The velocity of the ball that the agent has seen.
	HeardVelocity    *RpcVector2D `protobuf:"bytes,7,opt,name=heard_velocity,json=heardVelocity,proto3" json:"heard_velocity,omitempty"`          // The velocity of the ball that the agent has heard.
	PosCount         int32        `protobuf:"varint,8,opt,name=pos_count,json=posCount,proto3" json:"pos_count,omitempty"`                        // How many cycles ago the agent has seen or heard the ball.
	SeenPosCount     int32        `protobuf:"varint,9,opt,name=seen_pos_count,json=seenPosCount,proto3" json:"seen_pos_count,omitempty"`          // How many cycles ago the agent has seen the ball.
	HeardPosCount    int32        `protobuf:"varint,10,opt,name=heard_pos_count,json=heardPosCount,proto3" json:"heard_pos_count,omitempty"`      // How many cycles ago the agent has heard the ball.
	VelCount         int32        `protobuf:"varint,11,opt,name=vel_count,json=velCount,proto3" json:"vel_count,omitempty"`                       // How many cycles ago the agent has seen or heard the velocity of the ball.
	SeenVelCount     int32        `protobuf:"varint,12,opt,name=seen_vel_count,json=seenVelCount,proto3" json:"seen_vel_count,omitempty"`         // How many cycles ago the agent has seen the velocity of the ball.
	HeardVelCount    int32        `protobuf:"varint,13,opt,name=heard_vel_count,json=heardVelCount,proto3" json:"heard_vel_count,omitempty"`      // How many cycles ago the agent has heard the velocity of the ball.
	LostCount        int32        `protobuf:"varint,14,opt,name=lost_count,json=lostCount,proto3" json:"lost_count,omitempty"`                    // How many cycles ago the agent has lost the ball.
	GhostCount       int32        `protobuf:"varint,15,opt,name=ghost_count,json=ghostCount,proto3" json:"ghost_count,omitempty"`
	DistFromSelf     float32      `protobuf:"fixed32,16,opt,name=dist_from_self,json=distFromSelf,proto3" json:"dist_from_self,omitempty"`    // The distance of the ball from the agent who is sending the message.
	AngleFromSelf    float32      `protobuf:"fixed32,17,opt,name=angle_from_self,json=angleFromSelf,proto3" json:"angle_from_self,omitempty"` // The angle of the ball from the agent who is sending the message.
}
...
type Player struct {
	...
	Position              *RpcVector2D `protobuf:"bytes,1,opt,name=position,proto3" json:"position,omitempty"`                                                              // The position of the player.
	SeenPosition          *RpcVector2D `protobuf:"bytes,2,opt,name=seen_position,json=seenPosition,proto3" json:"seen_position,omitempty"`                                  // The position of the player that the agent has seen.
	HeardPosition         *RpcVector2D `protobuf:"bytes,3,opt,name=heard_position,json=heardPosition,proto3" json:"heard_position,omitempty"`                               // The position of the player that the agent has heard.
	Velocity              *RpcVector2D `protobuf:"bytes,4,opt,name=velocity,proto3" json:"velocity,omitempty"`                                                              // The velocity of the player.
	SeenVelocity          *RpcVector2D `protobuf:"bytes,5,opt,name=seen_velocity,json=seenVelocity,proto3" json:"seen_velocity,omitempty"`                                  // The velocity of the player that the agent has seen.
	PosCount              int32        `protobuf:"varint,6,opt,name=pos_count,json=posCount,proto3" json:"pos_count,omitempty"`                                             // How many cycles ago the agent has seen or heard the player.
	SeenPosCount          int32        `protobuf:"varint,7,opt,name=seen_pos_count,json=seenPosCount,proto3" json:"seen_pos_count,omitempty"`                               // How many cycles ago the agent has seen the player.
	HeardPosCount         int32        `protobuf:"varint,8,opt,name=heard_pos_count,json=heardPosCount,proto3" json:"heard_pos_count,omitempty"`                            // How many cycles ago the agent has heard the player.
	VelCount              int32        `protobuf:"varint,9,opt,name=vel_count,json=velCount,proto3" json:"vel_count,omitempty"`                                             // How many cycles ago the agent has seen or heard the velocity of the player.
	SeenVelCount          int32        `protobuf:"varint,10,opt,name=seen_vel_count,json=seenVelCount,proto3" json:"seen_vel_count,omitempty"`                              // How many cycles ago the agent has seen the velocity of the player.
	GhostCount            int32        `protobuf:"varint,11,opt,name=ghost_count,json=ghostCount,proto3" json:"ghost_count,omitempty"`                                      // How many cycles ago the agent has lost the player.
	DistFromSelf          float32      `protobuf:"fixed32,12,opt,name=dist_from_self,json=distFromSelf,proto3" json:"dist_from_self,omitempty"`                             // The distance of the player from the agent who is sending the message.
	AngleFromSelf         float32      `protobuf:"fixed32,13,opt,name=angle_from_self,json=angleFromSelf,proto3" json:"angle_from_self,omitempty"`                          // The angle of the player from the agent who is sending the message.
	Id                    int32        `protobuf:"varint,14,opt,name=id,proto3" json:"id,omitempty"`                                                                        // The unique identifier of the player.
	Side                  Side         `protobuf:"varint,15,opt,name=side,proto3,enum=protos.Side" json:"side,omitempty"`                                                   // The side of the player. It can be LEFT or RIGHT or UNKNOWN if the side is not known.
	UniformNumber         int32        `protobuf:"varint,16,opt,name=uniform_number,json=uniformNumber,proto3" json:"uniform_number,omitempty"`                             // The uniform number of the player.
	UniformNumberCount    int32        `protobuf:"varint,17,opt,name=uniform_number_count,json=uniformNumberCount,proto3" json:"uniform_number_count,omitempty"`            // How many cycles ago the agent has seen the uniform number of the player.
	IsGoalie              bool         `protobuf:"varint,18,opt,name=is_goalie,json=isGoalie,proto3" json:"is_goalie,omitempty"`                                            // Whether the player is a goalie or not.
	BodyDirection         float32      `protobuf:"fixed32,19,opt,name=body_direction,json=bodyDirection,proto3" json:"body_direction,omitempty"`                            // The body direction of the player.
	BodyDirectionCount    int32        `protobuf:"varint,20,opt,name=body_direction_count,json=bodyDirectionCount,proto3" json:"body_direction_count,omitempty"`            // How many cycles ago the agent has seen the body direction of the player.
	FaceDirection         float32      `protobuf:"fixed32,21,opt,name=face_direction,json=faceDirection,proto3" json:"face_direction,omitempty"`                            // The face direction of the player. In soccer simulation 2D, face direction is the direction that the player is looking at.
	FaceDirectionCount    int32        `protobuf:"varint,22,opt,name=face_direction_count,json=faceDirectionCount,proto3" json:"face_direction_count,omitempty"`            // How many cycles ago the agent has seen the face direction of the player.
	PointToDirection      float32      `protobuf:"fixed32,23,opt,name=point_to_direction,json=pointToDirection,proto3" json:"point_to_direction,omitempty"`                 // The direction that the player is pointing to.
	PointToDirectionCount int32        `protobuf:"varint,24,opt,name=point_to_direction_count,json=pointToDirectionCount,proto3" json:"point_to_direction_count,omitempty"` // How many cycles ago the agent has seen the point to direction of the player.
	IsKicking             bool         `protobuf:"varint,25,opt,name=is_kicking,json=isKicking,proto3" json:"is_kicking,omitempty"`                                         // Whether the player is kicking or not.
	DistFromBall          float32      `protobuf:"fixed32,26,opt,name=dist_from_ball,json=distFromBall,proto3" json:"dist_from_ball,omitempty"`                             // The distance of the player from the ball.
	AngleFromBall         float32      `protobuf:"fixed32,27,opt,name=angle_from_ball,json=angleFromBall,proto3" json:"angle_from_ball,omitempty"`                          // The angle of the player from the ball.
	BallReachSteps        int32        `protobuf:"varint,28,opt,name=ball_reach_steps,json=ballReachSteps,proto3" json:"ball_reach_steps,omitempty"`                        // How many cycles the player needs to reach the ball.
	IsTackling            bool         `protobuf:"varint,29,opt,name=is_tackling,json=isTackling,proto3" json:"is_tackling,omitempty"`                                      // Whether the player is tackling or not.
	TypeId                int32        `protobuf:"varint,30,opt,name=type_id,json=typeId,proto3" json:"type_id,omitempty"`                                                  // The type identifier of the player.
}
...
type Self struct {
	...
	Position              *RpcVector2D `protobuf:"bytes,1,opt,name=position,proto3" json:"position,omitempty"`                                                              // The position of the agent.
	SeenPosition          *RpcVector2D `protobuf:"bytes,2,opt,name=seen_position,json=seenPosition,proto3" json:"seen_position,omitempty"`                                  // The position of the agent that the agent has seen. (By using flags)
	HeardPosition         *RpcVector2D `protobuf:"bytes,3,opt,name=heard_position,json=heardPosition,proto3" json:"heard_position,omitempty"`                               // The position of the agent that the agent has heard. (This is not very useful)
	Velocity              *RpcVector2D `protobuf:"bytes,4,opt,name=velocity,proto3" json:"velocity,omitempty"`                                                              // The velocity of the agent.
	SeenVelocity          *RpcVector2D `protobuf:"bytes,5,opt,name=seen_velocity,json=seenVelocity,proto3" json:"seen_velocity,omitempty"`                                  // The velocity of the agent that the agent has seen. (By using flags)
	PosCount              int32        `protobuf:"varint,6,opt,name=pos_count,json=posCount,proto3" json:"pos_count,omitempty"`                                             // How many cycles ago the agent has seen or heard itself.
	SeenPosCount          int32        `protobuf:"varint,7,opt,name=seen_pos_count,json=seenPosCount,proto3" json:"seen_pos_count,omitempty"`                               // How many cycles ago the agent has seen itself.
	HeardPosCount         int32        `protobuf:"varint,8,opt,name=heard_pos_count,json=heardPosCount,proto3" json:"heard_pos_count,omitempty"`                            // How many cycles ago the agent has heard itself.
	VelCount              int32        `protobuf:"varint,9,opt,name=vel_count,json=velCount,proto3" json:"vel_count,omitempty"`                                             // How many cycles ago the agent has seen or heard the velocity of itself.
	SeenVelCount          int32        `protobuf:"varint,10,opt,name=seen_vel_count,json=seenVelCount,proto3" json:"seen_vel_count,omitempty"`                              // How many cycles ago the agent has seen the velocity of itself.
	GhostCount            int32        `protobuf:"varint,11,opt,name=ghost_count,json=ghostCount,proto3" json:"ghost_count,omitempty"`                                      // How many cycles ago the agent has lost itself.
	Id                    int32        `protobuf:"varint,12,opt,name=id,proto3" json:"id,omitempty"`                                                                        // The ID number for this object in proxy.
	Side                  Side         `protobuf:"varint,13,opt,name=side,proto3,enum=protos.Side" json:"side,omitempty"`                                                   // The side of the agent. It can be LEFT or RIGHT or UNKNOWN if the side is not known.
	UniformNumber         int32        `protobuf:"varint,14,opt,name=uniform_number,json=uniformNumber,proto3" json:"uniform_number,omitempty"`                             // The uniform number of the agent.
	UniformNumberCount    int32        `protobuf:"varint,15,opt,name=uniform_number_count,json=uniformNumberCount,proto3" json:"uniform_number_count,omitempty"`            // How many cycles ago the agent has seen the uniform number of itself.
	IsGoalie              bool         `protobuf:"varint,16,opt,name=is_goalie,json=isGoalie,proto3" json:"is_goalie,omitempty"`                                            // Whether the agent is a goalie or not.
	BodyDirection         float32      `protobuf:"fixed32,17,opt,name=body_direction,json=bodyDirection,proto3" json:"body_direction,omitempty"`                            // The body direction of the agent.
	BodyDirectionCount    int32        `protobuf:"varint,18,opt,name=body_direction_count,json=bodyDirectionCount,proto3" json:"body_direction_count,omitempty"`            // How many cycles ago the agent has seen the body direction of itself.
	FaceDirection         float32      `protobuf:"fixed32,19,opt,name=face_direction,json=faceDirection,proto3" json:"face_direction,omitempty"`                            // The face direction of the agent. In soccer simulation 2D, face direction is the direction that the agent is looking at. This is a global direction.
	FaceDirectionCount    int32        `protobuf:"varint,20,opt,name=face_direction_count,json=faceDirectionCount,proto3" json:"face_direction_count,omitempty"`            // How many cycles ago the agent has seen the face direction of itself.
	PointToDirection      float32      `protobuf:"fixed32,21,opt,name=point_to_direction,json=pointToDirection,proto3" json:"point_to_direction,omitempty"`                 // The direction that the agent is pointing to. This is a global direction.
	PointToDirectionCount int32        `protobuf:"varint,22,opt,name=point_to_direction_count,json=pointToDirectionCount,proto3" json:"point_to_direction_count,omitempty"` // How many cycles ago the agent has seen the point to direction of itself.
	IsKicking             bool         `protobuf:"varint,23,opt,name=is_kicking,json=isKicking,proto3" json:"is_kicking,omitempty"`                                         // Whether the agent is kicking or not.
	DistFromBall          float32      `protobuf:"fixed32,24,opt,name=dist_from_ball,json=distFromBall,proto3" json:"dist_from_ball,omitempty"`                             // The distance of the agent from the ball.
	AngleFromBall         float32      `protobuf:"fixed32,25,opt,name=angle_from_ball,json=angleFromBall,proto3" json:"angle_from_ball,omitempty"`                          // The angle of the agent from the ball.
	BallReachSteps        int32        `protobuf:"varint,26,opt,name=ball_reach_steps,json=ballReachSteps,proto3" json:"ball_reach_steps,omitempty"`                        // How many cycles the agent needs to reach the ball.
	IsTackling            bool         `protobuf:"varint,27,opt,name=is_tackling,json=isTackling,proto3" json:"is_tackling,omitempty"`                                      // Whether the agent is tackling or not.
	RelativeNeckDirection float32      `protobuf:"fixed32,28,opt,name=relative_neck_direction,json=relativeNeckDirection,proto3" json:"relative_neck_direction,omitempty"`  // The relative neck direction of the agent to the body direction.
	Stamina               float32      `protobuf:"fixed32,29,opt,name=stamina,proto3" json:"stamina,omitempty"`                                                             // The stamina of the agent. This number is between TODO
	IsKickable            bool         `protobuf:"varint,30,opt,name=is_kickable,json=isKickable,proto3" json:"is_kickable,omitempty"`                                      // Whether the agent is kickable or not. Means the agent can kick the ball.
	CatchProbability      float32      `protobuf:"fixed32,31,opt,name=catch_probability,json=catchProbability,proto3" json:"catch_probability,omitempty"`                   // The probability of the agent to catch the ball. This number is important for goalies.
	TackleProbability     float32      `protobuf:"fixed32,32,opt,name=tackle_probability,json=tackleProbability,proto3" json:"tackle_probability,omitempty"`                // The probability of the agent to tackle the ball.
	FoulProbability       float32      `protobuf:"fixed32,33,opt,name=foul_probability,json=foulProbability,proto3" json:"foul_probability,omitempty"`                      // The probability of the agent to foul.
	ViewWidth             ViewWidth    `protobuf:"varint,34,opt,name=view_width,json=viewWidth,proto3,enum=protos.ViewWidth" json:"view_width,omitempty"`                   // The view width of the agent. It can be NARROW, NORMAL, or WIDE.
	TypeId                int32        `protobuf:"varint,35,opt,name=type_id,json=typeId,proto3" json:"type_id,omitempty"`                                                  // The type identifier of the agent. The RcssServer generates 18 different types of agents. The coach is reponsible to give the type information to the agent.
	KickRate              float32      `protobuf:"fixed32,36,opt,name=kick_rate,json=kickRate,proto3" json:"kick_rate,omitempty"`                                           // The kick rate of the agent. This number is calculated by this formula: self.playerType().kickRate(wm.ball().distFromSelf(), (wm.ball().angleFromSelf() - self.body()).degree()), So, if the kick rate is more, the agent can kick the ball with more first speed to any angle.
	Recovery              float32      `protobuf:"fixed32,37,opt,name=recovery,proto3" json:"recovery,omitempty"`                                                           // The current estimated recovery value. TODO more info
	StaminaCapacity       float32      `protobuf:"fixed32,38,opt,name=stamina_capacity,json=staminaCapacity,proto3" json:"stamina_capacity,omitempty"`                      // The stamina capacity of the agent. This number is between 0 to ~130000 depending on the server param.
	Card                  CardType     `protobuf:"varint,39,opt,name=card,proto3,enum=protos.CardType" json:"card,omitempty"`                                               // The card type of the agent. It can be NO_CARD, YELLOW, or RED.
	CatchTime             int32        `protobuf:"varint,40,opt,name=catch_time,json=catchTime,proto3" json:"catch_time,omitempty"`                                         // The time when the last catch command is performed.
	Effort                float32      `protobuf:"fixed32,41,opt,name=effort,proto3" json:"effort,omitempty"`                                                               // The effort of the agent. TODO more info
}
...
type InterceptInfo struct {
	...
	ActionType        InterceptActionType `protobuf:"varint,1,opt,name=action_type,json=actionType,proto3,enum=protos.InterceptActionType" json:"action_type,omitempty"` // The type of the intercept action.
	TurnSteps         int32               `protobuf:"varint,2,opt,name=turn_steps,json=turnSteps,proto3" json:"turn_steps,omitempty"`                                    // The number of steps that the agent needs to turn to the ball.
	TurnAngle         float32             `protobuf:"fixed32,3,opt,name=turn_angle,json=turnAngle,proto3" json:"turn_angle,omitempty"`                                   // The angle that the agent needs to turn to the ball.
	DashSteps         int32               `protobuf:"varint,4,opt,name=dash_steps,json=dashSteps,proto3" json:"dash_steps,omitempty"`                                    // The number of steps that the agent needs to dash to the ball.
	DashPower         float32             `protobuf:"fixed32,5,opt,name=dash_power,json=dashPower,proto3" json:"dash_power,omitempty"`                                   // The power of the dash action.
	DashDir           float32             `protobuf:"fixed32,6,opt,name=dash_dir,json=dashDir,proto3" json:"dash_dir,omitempty"`                                         // The direction of the dash action to player's body direction.
	FinalSelfPosition *RpcVector2D        `protobuf:"bytes,7,opt,name=final_self_position,json=finalSelfPosition,proto3" json:"final_self_position,omitempty"`           // The final position of the agent after the intercept action.
	FinalBallDist     float32             `protobuf:"fixed32,8,opt,name=final_ball_dist,json=finalBallDist,proto3" json:"final_ball_dist,omitempty"`                     // The final distance of the ball from the agent after the intercept action.
	FinalStamina      float32             `protobuf:"fixed32,9,opt,name=final_stamina,json=finalStamina,proto3" json:"final_stamina,omitempty"`                          // The final stamina of the agent after the intercept action.
	Value             float32             `protobuf:"fixed32,10,opt,name=value,proto3" json:"value,omitempty"`                                                           // The value of the intercept action. TODO less is better or more is better?
}
...
type InterceptTable struct {
	...
	SelfReachSteps           int32            `protobuf:"varint,1,opt,name=self_reach_steps,json=selfReachSteps,proto3" json:"self_reach_steps,omitempty"`                                 // The number of steps that the agent needs to reach the ball.
	FirstTeammateReachSteps  int32            `protobuf:"varint,2,opt,name=first_teammate_reach_steps,json=firstTeammateReachSteps,proto3" json:"first_teammate_reach_steps,omitempty"`    // The number of steps that the first teammate needs to reach the ball.
	SecondTeammateReachSteps int32            `protobuf:"varint,3,opt,name=second_teammate_reach_steps,json=secondTeammateReachSteps,proto3" json:"second_teammate_reach_steps,omitempty"` // The number of steps that the second teammate needs to reach the ball.
	FirstOpponentReachSteps  int32            `protobuf:"varint,4,opt,name=first_opponent_reach_steps,json=firstOpponentReachSteps,proto3" json:"first_opponent_reach_steps,omitempty"`    // The number of steps that the first opponent needs to reach the ball.
	SecondOpponentReachSteps int32            `protobuf:"varint,5,opt,name=second_opponent_reach_steps,json=secondOpponentReachSteps,proto3" json:"second_opponent_reach_steps,omitempty"` // The number of steps that the second opponent needs to reach the ball.
	FirstTeammateId          int32            `protobuf:"varint,6,opt,name=first_teammate_id,json=firstTeammateId,proto3" json:"first_teammate_id,omitempty"`                              // The ID of the first teammate. This ID is unique for each player's object in the each agent proxy. If the ID is 0, it means the agent has no first teammate.
	SecondTeammateId         int32            `protobuf:"varint,7,opt,name=second_teammate_id,json=secondTeammateId,proto3" json:"second_teammate_id,omitempty"`                           // The ID of the second teammate. This ID is unique for each player's object in the each agent proxy. If the ID is 0, it means the agent has no second teammate.
	FirstOpponentId          int32            `protobuf:"varint,8,opt,name=first_opponent_id,json=firstOpponentId,proto3" json:"first_opponent_id,omitempty"`                              // The ID of the first opponent. This ID is unique for each player's object in the each agent proxy. If the ID is 0, it means the agent has no first opponent.
	SecondOpponentId         int32            `protobuf:"varint,9,opt,name=second_opponent_id,json=secondOpponentId,proto3" json:"second_opponent_id,omitempty"`                           // The ID of the second opponent. This ID is unique for each player's object in the each agent proxy. If the ID is 0, it means the agent has no second opponent.
	SelfInterceptInfo        []*InterceptInfo `protobuf:"bytes,10,rep,name=self_intercept_info,json=selfInterceptInfo,proto3" json:"self_intercept_info,omitempty"`                        // The intercept information of the agent.
}
...
type WorldModel struct {
	...
	InterceptTable            *InterceptTable        `protobuf:"bytes,1,opt,name=intercept_table,json=interceptTable,proto3" json:"intercept_table,omitempty"`                          // The intercept table of the agent.
	OurTeamName               string                 `protobuf:"bytes,2,opt,name=our_team_name,json=ourTeamName,proto3" json:"our_team_name,omitempty"`                                 // The name of our team.
	TheirTeamName             string                 `protobuf:"bytes,3,opt,name=their_team_name,json=theirTeamName,proto3" json:"their_team_name,omitempty"`                           // The name of their team.
	OurSide                   Side                   `protobuf:"varint,4,opt,name=our_side,json=ourSide,proto3,enum=protos.Side" json:"our_side,omitempty"`                             // The side of our team. It can be LEFT or RIGHT.
	LastSetPlayStartTime      int32                  `protobuf:"varint,5,opt,name=last_set_play_start_time,json=lastSetPlayStartTime,proto3" json:"last_set_play_start_time,omitempty"` // The last set play start time.
	Self                      *Self                  `protobuf:"bytes,6,opt,name=self,proto3" json:"self,omitempty"`                                                                    // The information about the agent itself.
	Ball                      *Ball                  `protobuf:"bytes,7,opt,name=ball,proto3" json:"ball,omitempty"`                                                                    // The information about the ball.
	...
	OurGoalieUniformNumber    int32                  `protobuf:"varint,13,opt,name=our_goalie_uniform_number,json=ourGoalieUniformNumber,proto3" json:"our_goalie_uniform_number,omitempty"`                                                                              // The uniform number of our goalie.
	TheirGoalieUniformNumber  int32                  `protobuf:"varint,14,opt,name=their_goalie_uniform_number,json=theirGoalieUniformNumber,proto3" json:"their_goalie_uniform_number,omitempty"`                                                                        // The uniform number of their goalie.
	OffsideLineX              float32                `protobuf:"fixed32,15,opt,name=offside_line_x,json=offsideLineX,proto3" json:"offside_line_x,omitempty"`                                                                                                             // The x-coordinate of the offside line of opponent team.
	OfsideLineXCount          int32                  `protobuf:"varint,16,opt,name=ofside_line_x_count,json=ofsideLineXCount,proto3" json:"ofside_line_x_count,omitempty"`                                                                                                // How many cycles ago the agent has seen (calculated) the offside line.
	KickableTeammateId        int32                  `protobuf:"varint,17,opt,name=kickable_teammate_id,json=kickableTeammateId,proto3" json:"kickable_teammate_id,omitempty"`                                                                                            // The ID of the kickable teammate. To get the information about the kickable teammate, you can find a player in teammates or our_players_dict with this ID.
	KickableOpponentId        int32                  `protobuf:"varint,18,opt,name=kickable_opponent_id,json=kickableOpponentId,proto3" json:"kickable_opponent_id,omitempty"`                                                                                            // The ID of the kickable opponent. To get the information about the kickable opponent, you can find a player in opponents or their_players_dict with this ID.
	LastKickSide              Side                   `protobuf:"varint,19,opt,name=last_kick_side,json=lastKickSide,proto3,enum=protos.Side" json:"last_kick_side,omitempty"`                                                                                             // The last side that the ball was kicked.
	LastKickerUniformNumber   int32                  `protobuf:"varint,20,opt,name=last_kicker_uniform_number,json=lastKickerUniformNumber,proto3" json:"last_kicker_uniform_number,omitempty"`                                                                           // The last uniform number that the ball was kicked.
	Cycle                     int32                  `protobuf:"varint,21,opt,name=cycle,proto3" json:"cycle,omitempty"`                                                                                                                                                  // The current cycle of the game.
	GameModeType              GameModeType           `protobuf:"varint,22,opt,name=game_mode_type,json=gameModeType,proto3,enum=protos.GameModeType" json:"game_mode_type,omitempty"`                                                                                     // The current game mode type.
	LeftTeamScore             int32                  `protobuf:"varint,23,opt,name=left_team_score,json=leftTeamScore,proto3" json:"left_team_score,omitempty"`                                                                                                           // The score of the left team.
	RightTeamScore            int32                  `protobuf:"varint,24,opt,name=right_team_score,json=rightTeamScore,proto3" json:"right_team_score,omitempty"`                                                                                                        // The score of the right team.
	IsOurSetPlay              bool                   `protobuf:"varint,25,opt,name=is_our_set_play,json=isOurSetPlay,proto3" json:"is_our_set_play,omitempty"`                                                                                                            // Whether it is our set play or not.
	IsTheirSetPlay            bool                   `protobuf:"varint,26,opt,name=is_their_set_play,json=isTheirSetPlay,proto3" json:"is_their_set_play,omitempty"`                                                                                                      // Whether it is their set play or not.
	StopedCycle               int32                  `protobuf:"varint,27,opt,name=stoped_cycle,json=stopedCycle,proto3" json:"stoped_cycle,omitempty"`                                                                                                                   // The number of cycles that the game has stopped. For example, when the cycle is 90, and stoped_cycle is 10, it means the game has stopped at 90th cycle for 10 cycles.
	OurTeamScore              int32                  `protobuf:"varint,28,opt,name=our_team_score,json=ourTeamScore,proto3" json:"our_team_score,omitempty"`                                                                                                              // The score of our team.
	TheirTeamScore            int32                  `protobuf:"varint,29,opt,name=their_team_score,json=theirTeamScore,proto3" json:"their_team_score,omitempty"`                                                                                                        // The score of their team.
	IsPenaltyKickMode         bool                   `protobuf:"varint,30,opt,name=is_penalty_kick_mode,json=isPenaltyKickMode,proto3" json:"is_penalty_kick_mode,omitempty"`                                                                                             // Whether it is penalty kick mode or not.
	HeliosHomePositions       map[int32]*RpcVector2D `protobuf:"bytes,31,rep,name=helios_home_positions,json=heliosHomePositions,proto3" json:"helios_home_positions,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // The home positions of the agents in the helios strategy. Helios base code is using Delanaray triangulation to calculate the home positions.
	OurDefenseLineX           float64                `protobuf:"fixed64,32,opt,name=our_defense_line_x,json=ourDefenseLineX,proto3" json:"our_defense_line_x,omitempty"`                                                                                                  // The x-coordinate of our defense line. The diffence line is minimum x-coordinate of our players (except goalie) and ball.
	TheirDefenseLineX         float64                `protobuf:"fixed64,33,opt,name=their_defense_line_x,json=theirDefenseLineX,proto3" json:"their_defense_line_x,omitempty"`                                                                                            // The x-coordinate of their defense line. The diffence line is minimum x-coordinate of their players (except goalie) and ball.
	OurDefensePlayerLineX     float64                `protobuf:"fixed64,34,opt,name=our_defense_player_line_x,json=ourDefensePlayerLineX,proto3" json:"our_defense_player_line_x,omitempty"`                                                                              // The x-coordinate of our defense player line. The diffence player line is minimum x-coordinate of our players (except goalie).
	TheirDefensePlayerLineX   float64                `protobuf:"fixed64,35,opt,name=their_defense_player_line_x,json=theirDefensePlayerLineX,proto3" json:"their_defense_player_line_x,omitempty"`                                                                        // The x-coordinate of their defense player line. The diffence player line is minimum x-coordinate of their players (except goalie).
	KickableTeammateExistance bool                   `protobuf:"varint,36,opt,name=kickable_teammate_existance,json=kickableTeammateExistance,proto3" json:"kickable_teammate_existance,omitempty"`                                                                       // Whether the kickable teammate exists or not.
	KickableOpponentExistance bool                   `protobuf:"varint,37,opt,name=kickable_opponent_existance,json=kickableOpponentExistance,proto3" json:"kickable_opponent_existance,omitempty"`                                                                       // Whether the kickable opponent exists or not.
	PenaltyKickState          *PenaltyKickState      `protobuf:"bytes,38,opt,name=penalty_kick_state,json=penaltyKickState,proto3" json:"penalty_kick_state,omitempty"`                                                                                                   // The penalty kick state.
	SeeTime                   int32                  `protobuf:"varint,39,opt,name=see_time,json=seeTime,proto3" json:"see_time,omitempty"`                                                                                                                               // The time that the agent has seen the world model.
...
type State struct {
	...
	RegisterResponse *RegisterResponse `protobuf:"bytes,1,opt,name=register_response,json=registerResponse,proto3" json:"register_response,omitempty"` // The response of the agent registration. The agent should use this information to identify itself to the playermaker server.
	WorldModel       *WorldModel       `protobuf:"bytes,2,opt,name=world_model,json=worldModel,proto3" json:"world_model,omitempty"`                   // The world model of the agent. The agent should use this information to make decisions. If the server is in full state mode, the world model will be full state without noise.
	FullWorldModel   *WorldModel       `protobuf:"bytes,3,opt,name=full_world_model,json=fullWorldModel,proto3" json:"full_world_model,omitempty"`     // The full world model of the agent. This value will be set only if the server is in full state mode and proxy agent is in debug mode. TODO add more information
	NeedPreprocess   bool              `protobuf:"varint,4,opt,name=need_preprocess,json=needPreprocess,proto3" json:"need_preprocess,omitempty"`      // Whether the agent needs to preprocess the world model or not. If the agent needs to do some preprocessing actions, it means the proxy agent will igonre the playmaker actions, you can ignore preprocessing.
}
...
type Dash struct {
	...
	Power             float32 `protobuf:"fixed32,1,opt,name=power,proto3" json:"power,omitempty"`                                                  // The power of the dash action. The power can be between -100 to 100. If the power is negative, the agent will dash in the backward direction by using two times of the power.
	RelativeDirection float32 `protobuf:"fixed32,2,opt,name=relative_direction,json=relativeDirection,proto3" json:"relative_direction,omitempty"` // The relative direction of the dash action to the body direction of the agent. The direction can be between -180 to 180.
}
...
type Turn struct {
	...
	RelativeDirection float32 `protobuf:"fixed32,1,opt,name=relative_direction,json=relativeDirection,proto3" json:"relative_direction,omitempty"` // The relative direction of the turn action to the body direction of the agent. The direction can be between -180 to 180.
}
...
type HeliosOffensivePlanner struct {
	...
	MaxDepth           int32              `protobuf:"varint,11,opt,name=max_depth,json=maxDepth,proto3" json:"max_depth,omitempty"`
	MaxNodes           int32              `protobuf:"varint,12,opt,name=max_nodes,json=maxNodes,proto3" json:"max_nodes,omitempty"`
	Evaluation         *PlannerEvaluation `protobuf:"bytes,13,opt,name=evaluation,proto3" json:"evaluation,omitempty"` //* The evaluation methods to evaluate the actions[predicted states] in the tree.
}
...
func (x *HeliosOffensivePlanner) GetMaxDepth() int32 {
	if x != nil {
		return x.MaxDepth
	}
	return 0
...
func (x *HeliosOffensivePlanner) GetMaxNodes() int32 {
	if x != nil {
		return x.MaxNodes
	}
	return 0
...
func (x *HeliosOffensivePlanner) GetEvaluation() *PlannerEvaluation {
	if x != nil {
		return x.Evaluation
	}
	return nil
...
// ```
type OpponentEffector struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	NegetiveEffectByDistance                    []float32 `protobuf:"fixed32,1,rep,packed,name=negetive_effect_by_distance,json=negetiveEffectByDistance,proto3" json:"negetive_effect_by_distance,omitempty"`
	NegetiveEffectByDistanceBasedOnFirstLayer   bool      `protobuf:"varint,2,opt,name=negetive_effect_by_distance_based_on_first_layer,json=negetiveEffectByDistanceBasedOnFirstLayer,proto3" json:"negetive_effect_by_distance_based_on_first_layer,omitempty"`
	NegetiveEffectByReachSteps                  []float32 `protobuf:"fixed32,3,rep,packed,name=negetive_effect_by_reach_steps,json=negetiveEffectByReachSteps,proto3" json:"negetive_effect_by_reach_steps,omitempty"` //* The list of float values that represents the negetive effect of the reach steps of the opponent player to the ball in the predicted state.
	NegetiveEffectByReachStepsBasedOnFirstLayer bool      `protobuf:"varint,4,opt,name=negetive_effect_by_reach_steps_based_on_first_layer,json=negetiveEffectByReachStepsBasedOnFirstLayer,proto3" json:"negetive_effect_by_reach_steps_based_on_first_layer,omitempty"`
}

func (x *OpponentEffector) Reset() {
	*x = OpponentEffector{}
...
func (x *OpponentEffector) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OpponentEffector) ProtoMessage() {}

func (x *OpponentEffector) ProtoReflect() protoreflect.Message {
	mi := &file_service_proto_msgTypes[102]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OpponentEffector.ProtoReflect.Descriptor instead.
func (*OpponentEffector) Descriptor() ([]byte, []int) {
	return file_service_proto_rawDescGZIP(), []int{102}
}

func (x *OpponentEffector) GetNegetiveEffectByDistance() []float32 {
	if x != nil {
		return x.NegetiveEffectByDistance
	}
	return nil
}

func (x *OpponentEffector) GetNegetiveEffectByDistanceBasedOnFirstLayer() bool {
	if x != nil {
		return x.NegetiveEffectByDistanceBasedOnFirstLayer
	}
	return false
}

func (x *OpponentEffector) GetNegetiveEffectByReachSteps() []float32 {
	if x != nil {
		return x.NegetiveEffectByReachSteps
	}
	return nil
}

func (x *OpponentEffector) GetNegetiveEffectByReachStepsBasedOnFirstLayer() bool {
	if x != nil {
		return x.NegetiveEffectByReachStepsBasedOnFirstLayer
	}
	return false
}
...
// return pb2.PlayerActions(actions=actions)
// ```
type ActionTypeEffector struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	DirectPass   float32 `protobuf:"fixed32,1,opt,name=direct_pass,json=directPass,proto3" json:"direct_pass,omitempty"`       //* The coefficient of the direct pass action.
	LeadPass     float32 `protobuf:"fixed32,2,opt,name=lead_pass,json=leadPass,proto3" json:"lead_pass,omitempty"`             //* The coefficient of the lead pass action.
	ThroughPass  float32 `protobuf:"fixed32,3,opt,name=through_pass,json=throughPass,proto3" json:"through_pass,omitempty"`    //* The coefficient of the through pass action.
	ShortDribble float32 `protobuf:"fixed32,4,opt,name=short_dribble,json=shortDribble,proto3" json:"short_dribble,omitempty"` //* The coefficient of the short dribble action.
	LongDribble  float32 `protobuf:"fixed32,5,opt,name=long_dribble,json=longDribble,proto3" json:"long_dribble,omitempty"`    //* The coefficient of the long dribble action.
	Cross        float32 `protobuf:"fixed32,6,opt,name=cross,proto3" json:"cross,omitempty"`                                   //* The coefficient of the cross action.
	Hold         float32 `protobuf:"fixed32,7,opt,name=hold,proto3" json:"hold,omitempty"`                                     //* The coefficient of the hold action.
}

func (x *ActionTypeEffector) Reset() {
	*x = ActionTypeEffector{}
	mi := &file_service_proto_msgTypes[103]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ActionTypeEffector) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActionTypeEffector) ProtoMessage() {}

func (x *ActionTypeEffector) ProtoReflect() protoreflect.Message {
	mi := &file_service_proto_msgTypes[103]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ActionTypeEffector.ProtoReflect.Descriptor instead.
func (*ActionTypeEffector) Descriptor() ([]byte, []int) {
	return file_service_proto_rawDescGZIP(), []int{103}
}

func (x *ActionTypeEffector) GetDirectPass() float32 {
	if x != nil {
		return x.DirectPass
	}
	return 0
...
func (x *ActionTypeEffector) GetLeadPass() float32 {
	if x != nil {
		return x.LeadPass
	}
	return 0
...
func (x *ActionTypeEffector) GetThroughPass() float32 {
	if x != nil {
		return x.ThroughPass
	}
	return 0
...
func (x *ActionTypeEffector) GetShortDribble() float32 {
	if x != nil {
		return x.ShortDribble
	}
	return 0
...
func (x *ActionTypeEffector) GetLongDribble() float32 {
	if x != nil {
		return x.LongDribble
	}
	return 0
...
func (x *ActionTypeEffector) GetCross() float32 {
	if x != nil {
		return x.Cross
	}
	return 0
...
func (x *ActionTypeEffector) GetHold() float32 {
	if x != nil {
		return x.Hold
	}
	return 0
...
// return pb2.PlayerActions(actions=actions)
// ```
type TeammateEffector struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Coefficients           map[int32]float32 `protobuf:"bytes,1,rep,name=coefficients,proto3" json:"coefficients,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"fixed32,2,opt,name=value,proto3"`
	ApplyBasedOnFirstLayer bool              `protobuf:"varint,2,opt,name=apply_based_on_first_layer,json=applyBasedOnFirstLayer,proto3" json:"apply_based_on_first_layer,omitempty"`
}

func (x *TeammateEffector) Reset() {
	*x = TeammateEffector{}
...
func (x *TeammateEffector) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TeammateEffector) ProtoMessage() {}

func (x *TeammateEffector) ProtoReflect() protoreflect.Message {
	mi := &file_service_proto_msgTypes[104]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TeammateEffector.ProtoReflect.Descriptor instead.
func (*TeammateEffector) Descriptor() ([]byte, []int) {
	return file_service_proto_rawDescGZIP(), []int{104}
}

func (x *TeammateEffector) GetCoefficients() map[int32]float32 {
	if x != nil {
...
func (x *TeammateEffector) GetApplyBasedOnFirstLayer() bool {
	if x != nil {
		return x.ApplyBasedOnFirstLayer
	}
	return false
}
...
// return pb2.PlayerActions(actions=actions)
// ```
type PlannerEvaluationEffector struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	OpponentEffector   *OpponentEffector   `protobuf:"bytes,1,opt,name=opponent_effector,json=opponentEffector,proto3" json:"opponent_effector,omitempty"`
	ActionTypeEffector *ActionTypeEffector `protobuf:"bytes,2,opt,name=action_type_effector,json=actionTypeEffector,proto3" json:"action_type_effector,omitempty"`
	TeammateEffector   *TeammateEffector   `protobuf:"bytes,3,opt,name=teammate_effector,json=teammateEffector,proto3" json:"teammate_effector,omitempty"`
}

func (x *PlannerEvaluationEffector) Reset() {
	*x = PlannerEvaluationEffector{}
	mi := &file_service_proto_msgTypes[105]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PlannerEvaluationEffector) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PlannerEvaluationEffector) ProtoMessage() {}

func (x *PlannerEvaluationEffector) ProtoReflect() protoreflect.Message {
	mi := &file_service_proto_msgTypes[105]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PlannerEvaluationEffector.ProtoReflect.Descriptor instead.
func (*PlannerEvaluationEffector) Descriptor() ([]byte, []int) {
	return file_service_proto_rawDescGZIP(), []int{105}
}

func (x *PlannerEvaluationEffector) GetOpponentEffector() *OpponentEffector {
	if x != nil {
		return x.OpponentEffector
	}
	return nil
}

func (x *PlannerEvaluationEffector) GetActionTypeEffector() *ActionTypeEffector {
	if x != nil {
		return x.ActionTypeEffector
	}
	return nil
}

func (x *PlannerEvaluationEffector) GetTeammateEffector() *TeammateEffector {
	if x != nil {
		return x.TeammateEffector
	}
	return nil
}
...
// return pb2.PlayerActions(actions=actions)
// ```
type HeliosFieldEvaluator struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	XCoefficient               float32 `protobuf:"fixed32,1,opt,name=x_coefficient,json=xCoefficient,proto3" json:"x_coefficient,omitempty"`                                                   // The coefficient of the x-coordinate of the ball in the predicted state. The default value is 1.
	BallDistToGoalCoefficient  float32 `protobuf:"fixed32,2,opt,name=ball_dist_to_goal_coefficient,json=ballDistToGoalCoefficient,proto3" json:"ball_dist_to_goal_coefficient,omitempty"`      // The coefficient of the distance of the ball to the opponent goal center in the predicted state. The default value is 1.
	EffectiveMaxBallDistToGoal float32 `protobuf:"fixed32,3,opt,name=effective_max_ball_dist_to_goal,json=effectiveMaxBallDistToGoal,proto3" json:"effective_max_ball_dist_to_goal,omitempty"` // The effective maximum distance of the ball to the opponent goal center in the predicted state. The default value is 40.0.
}

func (x *HeliosFieldEvaluator) Reset() {
	*x = HeliosFieldEvaluator{}
	mi := &file_service_proto_msgTypes[106]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *HeliosFieldEvaluator) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HeliosFieldEvaluator) ProtoMessage() {}

func (x *HeliosFieldEvaluator) ProtoReflect() protoreflect.Message {
	mi := &file_service_proto_msgTypes[106]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HeliosFieldEvaluator.ProtoReflect.Descriptor instead.
func (*HeliosFieldEvaluator) Descriptor() ([]byte, []int) {
	return file_service_proto_rawDescGZIP(), []int{106}
}

func (x *HeliosFieldEvaluator) GetXCoefficient() float32 {
	if x != nil {
		return x.XCoefficient
	}
	return 0
}

func (x *HeliosFieldEvaluator) GetBallDistToGoalCoefficient() float32 {
	if x != nil {
		return x.BallDistToGoalCoefficient
	}
	return 0
}

func (x *HeliosFieldEvaluator) GetEffectiveMaxBallDistToGoal() float32 {
	if x != nil {
		return x.EffectiveMaxBallDistToGoal
	}
	return 0
}

type MatrixFieldEvaluatorY struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Evals []float32 `protobuf:"fixed32,1,rep,packed,name=evals,proto3" json:"evals,omitempty"`
}

func (x *MatrixFieldEvaluatorY) Reset() {
	*x = MatrixFieldEvaluatorY{}
	mi := &file_service_proto_msgTypes[107]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MatrixFieldEvaluatorY) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MatrixFieldEvaluatorY) ProtoMessage() {}

func (x *MatrixFieldEvaluatorY) ProtoReflect() protoreflect.Message {
	mi := &file_service_proto_msgTypes[107]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MatrixFieldEvaluatorY.ProtoReflect.Descriptor instead.
func (*MatrixFieldEvaluatorY) Descriptor() ([]byte, []int) {
	return file_service_proto_rawDescGZIP(), []int{107}
}

func (x *MatrixFieldEvaluatorY) GetEvals() []float32 {
	if x != nil {
		return x.Evals
	}
	return nil
...
// return pb2.PlayerActions(actions=actions)
// ```
type MatrixFieldEvaluator struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Evals []*MatrixFieldEvaluatorY `protobuf:"bytes,1,rep,name=evals,proto3" json:"evals,omitempty"`
}

func (x *MatrixFieldEvaluator) Reset() {
	*x = MatrixFieldEvaluator{}
	mi := &file_service_proto_msgTypes[108]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MatrixFieldEvaluator) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MatrixFieldEvaluator) ProtoMessage() {}

func (x *MatrixFieldEvaluator) ProtoReflect() protoreflect.Message {
	mi := &file_service_proto_msgTypes[108]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MatrixFieldEvaluator.ProtoReflect.Descriptor instead.
func (*MatrixFieldEvaluator) Descriptor() ([]byte, []int) {
	return file_service_proto_rawDescGZIP(), []int{108}
}

func (x *MatrixFieldEvaluator) GetEvals() []*MatrixFieldEvaluatorY {
	if x != nil {
		return x.Evals
	}
	return nil
...
type PlannerFieldEvaluator struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	HeliosFieldEvaluator *HeliosFieldEvaluator `protobuf:"bytes,1,opt,name=helios_field_evaluator,json=heliosFieldEvaluator,proto3" json:"helios_field_evaluator,omitempty"`
	MatrixFieldEvaluator *MatrixFieldEvaluator `protobuf:"bytes,2,opt,name=matrix_field_evaluator,json=matrixFieldEvaluator,proto3" json:"matrix_field_evaluator,omitempty"`
}

func (x *PlannerFieldEvaluator) Reset() {
	*x = PlannerFieldEvaluator{}
	mi := &file_service_proto_msgTypes[109]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PlannerFieldEvaluator) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PlannerFieldEvaluator) ProtoMessage() {}

func (x *PlannerFieldEvaluator) ProtoReflect() protoreflect.Message {
	mi := &file_service_proto_msgTypes[109]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PlannerFieldEvaluator.ProtoReflect.Descriptor instead.
func (*PlannerFieldEvaluator) Descriptor() ([]byte, []int) {
	return file_service_proto_rawDescGZIP(), []int{109}
}

func (x *PlannerFieldEvaluator) GetHeliosFieldEvaluator() *HeliosFieldEvaluator {
	if x != nil {
		return x.HeliosFieldEvaluator
	}
	return nil
}

func (x *PlannerFieldEvaluator) GetMatrixFieldEvaluator() *MatrixFieldEvaluator {
	if x != nil {
		return x.MatrixFieldEvaluator
	}
	return nil
}
...
type PlannerEvaluation struct {
	...
	Effectors       *PlannerEvaluationEffector `protobuf:"bytes,1,opt,name=effectors,proto3" json:"effectors,omitempty"`
	FieldEvaluators *PlannerFieldEvaluator     `protobuf:"bytes,2,opt,name=field_evaluators,json=fieldEvaluators,proto3" json:"field_evaluators,omitempty"`
}

func (x *PlannerEvaluation) Reset() {
	*x = PlannerEvaluation{}
...
func (x *PlannerEvaluation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PlannerEvaluation) ProtoMessage() {}

func (x *PlannerEvaluation) ProtoReflect() protoreflect.Message {
	mi := &file_service_proto_msgTypes[110]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PlannerEvaluation.ProtoReflect.Descriptor instead.
func (*PlannerEvaluation) Descriptor() ([]byte, []int) {
	return file_service_proto_rawDescGZIP(), []int{110}
}

func (x *PlannerEvaluation) GetEffectors() *PlannerEvaluationEffector {
	if x != nil {
		return x.Effectors
	}
	return nil
...
func (x *PlannerEvaluation) GetFieldEvaluators() *PlannerFieldEvaluator {
	if x != nil {
		return x.FieldEvaluators
	}
	return nil
}
...
type PlayerActions struct {
	...
	IgnoreDoIntention        bool            `protobuf:"varint,5,opt,name=ignore_doIntention,json=ignoreDoIntention,proto3" json:"ignore_doIntention,omitempty"`
	IgnoreShootInPreprocess  bool            `protobuf:"varint,6,opt,name=ignore_shootInPreprocess,json=ignoreShootInPreprocess,proto3" json:"ignore_shootInPreprocess,omitempty"`
}
...
func (x *PlayerActions) GetIgnoreDoIntention() bool {
	if x != nil {
		return x.IgnoreDoIntention
	}
	return false
}

func (x *PlayerActions) GetIgnoreShootInPreprocess() bool {
	if x != nil {
		return x.IgnoreShootInPreprocess
	}
	return false
}
...
var file_service_proto_rawDesc = []byte{
	...
	0x0b, 0x48, 0x65, 0x6c, 0x69, 0x6f, 0x73, 0x53, 0x68, 0x6f, 0x6f, 0x74, 0x22, 0xe9, 0x03, 0x0a,
	...
	,
...
var file_service_proto_goTypes = []any{
	...
	(*OpponentEffector)(nil),           // 111: protos.OpponentEffector
	(*ActionTypeEffector)(nil),         // 112: protos.ActionTypeEffector
	(*TeammateEffector)(nil),           // 113: protos.TeammateEffector
	(*PlannerEvaluationEffector)(nil),  // 114: protos.PlannerEvaluationEffector
	(*HeliosFieldEvaluator)(nil),       // 115: protos.HeliosFieldEvaluator
	(*MatrixFieldEvaluatorY)(nil),      // 116: protos.MatrixFieldEvaluatorY
	(*MatrixFieldEvaluator)(nil),       // 117: protos.MatrixFieldEvaluator
	(*PlannerFieldEvaluator)(nil),      // 118: protos.PlannerFieldEvaluator
	(*PlannerEvaluation)(nil),          // 119: protos.PlannerEvaluation
	(*HeliosBasicOffensive)(nil),       // 120: protos.HeliosBasicOffensive
	(*HeliosBasicMove)(nil),            // 121: protos.HeliosBasicMove
	(*HeliosSetPlay)(nil),              // 122: protos.HeliosSetPlay
	(*HeliosPenalty)(nil),              // 123: protos.HeliosPenalty
	(*HeliosCommunicaion)(nil),         // 124: protos.HeliosCommunicaion
	(*BhvDoForceKick)(nil),             // 125: protos.bhv_doForceKick
	(*BhvDoHeardPassRecieve)(nil),      // 126: protos.bhv_doHeardPassRecieve
	(*PlayerAction)(nil),               // 127: protos.PlayerAction
	(*PlayerActions)(nil),              // 128: protos.PlayerActions
	(*ChangePlayerType)(nil),           // 129: protos.ChangePlayerType
	(*DoHeliosSubstitute)(nil),         // 130: protos.DoHeliosSubstitute
	(*DoHeliosSayPlayerTypes)(nil),     // 131: protos.DoHeliosSayPlayerTypes
	(*CoachAction)(nil),                // 132: protos.CoachAction
	(*CoachActions)(nil),               // 133: protos.CoachActions
	(*DoKickOff)(nil),                  // 134: protos.DoKickOff
	(*DoMoveBall)(nil),                 // 135: protos.DoMoveBall
	(*DoMovePlayer)(nil),               // 136: protos.DoMovePlayer
	(*DoRecover)(nil),                  // 137: protos.DoRecover
	(*DoChangeMode)(nil),               // 138: protos.DoChangeMode
	(*DoChangePlayerType)(nil),         // 139: protos.DoChangePlayerType
	(*TrainerAction)(nil),              // 140: protos.TrainerAction
	(*TrainerActions)(nil),             // 141: protos.TrainerActions
	(*ServerParam)(nil),                // 142: protos.ServerParam
	(*PlayerParam)(nil),                // 143: protos.PlayerParam
	(*PlayerType)(nil),                 // 144: protos.PlayerType
	(*RpcCooperativeAction)(nil),       // 145: protos.RpcCooperativeAction
	(*RpcPredictState)(nil),            // 146: protos.RpcPredictState
	(*RpcActionState)(nil),             // 147: protos.RpcActionState
	(*BestPlannerActionRequest)(nil),   // 148: protos.BestPlannerActionRequest
	(*BestPlannerActionResponse)(nil),  // 149: protos.BestPlannerActionResponse
	(*Empty)(nil),                      // 150: protos.Empty
	nil,                                // 151: protos.WorldModel.OurPlayersDictEntry
	nil,                                // 152: protos.WorldModel.TheirPlayersDictEntry
	nil,                                // 153: protos.WorldModel.HeliosHomePositionsEntry
	nil,                                // 154: protos.TeammateEffector.CoefficientsEntry
	nil,                                // 155: protos.BestPlannerActionRequest.PairsEntry
}
var file_service_proto_depIdxs = []int32{
	...
	151, // 36: protos.WorldModel.our_players_dict:type_name -> protos.WorldModel.OurPlayersDictEntry
	152, // 37: protos.WorldModel.their_players_dict:type_name -> protos.WorldModel.TheirPlayersDictEntry
	...
	153, // 40: protos.WorldModel.helios_home_positions:type_name -> protos.WorldModel.HeliosHomePositionsEntry
	...
	119, // 143: protos.HeliosOffensivePlanner.evaluation:type_name -> protos.PlannerEvaluation
	154, // 144: protos.TeammateEffector.coefficients:type_name -> protos.TeammateEffector.CoefficientsEntry
	111, // 145: protos.PlannerEvaluationEffector.opponent_effector:type_name -> protos.OpponentEffector
	112, // 146: protos.PlannerEvaluationEffector.action_type_effector:type_name -> protos.ActionTypeEffector
	113, // 147: protos.PlannerEvaluationEffector.teammate_effector:type_name -> protos.TeammateEffector
	116, // 148: protos.MatrixFieldEvaluator.evals:type_name -> protos.MatrixFieldEvaluatorY
	115, // 149: protos.PlannerFieldEvaluator.helios_field_evaluator:type_name -> protos.HeliosFieldEvaluator
	117, // 150: protos.PlannerFieldEvaluator.matrix_field_evaluator:type_name -> protos.MatrixFieldEvaluator
	114, // 151: protos.PlannerEvaluation.effectors:type_name -> protos.PlannerEvaluationEffector
	118, // 152: protos.PlannerEvaluation.field_evaluators:type_name -> protos.PlannerFieldEvaluator
	21,  // 153: protos.PlayerAction.dash:type_name -> protos.Dash
	22,  // 154: protos.PlayerAction.turn:type_name -> protos.Turn
	23,  // 155: protos.PlayerAction.kick:type_name -> protos.Kick
	24,  // 156: protos.PlayerAction.tackle:type_name -> protos.Tackle
	25,  // 157: protos.PlayerAction.catch:type_name -> protos.Catch
	26,  // 158: protos.PlayerAction.move:type_name -> protos.Move
	27,  // 159: protos.PlayerAction.turn_neck:type_name -> protos.TurnNeck
	28,  // 160: protos.PlayerAction.change_view:type_name -> protos.ChangeView
	51,  // 161: protos.PlayerAction.say:type_name -> protos.Say
	52,  // 162: protos.PlayerAction.point_to:type_name -> protos.PointTo
	53,  // 163: protos.PlayerAction.point_to_of:type_name -> protos.PointToOf
	54,  // 164: protos.PlayerAction.attention_to:type_name -> protos.AttentionTo
	55,  // 165: protos.PlayerAction.attention_to_of:type_name -> protos.AttentionToOf
	65,  // 166: protos.PlayerAction.log:type_name -> protos.Log
	66,  // 167: protos.PlayerAction.debug_client:type_name -> protos.DebugClient
	67,  // 168: protos.PlayerAction.body_go_to_point:type_name -> protos.Body_GoToPoint
	68,  // 169: protos.PlayerAction.body_smart_kick:type_name -> protos.Body_SmartKick
	69,  // 170: protos.PlayerAction.bhv_before_kick_off:type_name -> protos.Bhv_BeforeKickOff
	70,  // 171: protos.PlayerAction.bhv_body_neck_to_ball:type_name -> protos.Bhv_BodyNeckToBall
	71,  // 172: protos.PlayerAction.bhv_body_neck_to_point:type_name -> protos.Bhv_BodyNeckToPoint
	72,  // 173: protos.PlayerAction.bhv_emergency:type_name -> protos.Bhv_Emergency
	73,  // 174: protos.PlayerAction.bhv_go_to_point_look_ball:type_name -> protos.Bhv_GoToPointLookBall
	74,  // 175: protos.PlayerAction.bhv_neck_body_to_ball:type_name -> protos.Bhv_NeckBodyToBall
	75,  // 176: protos.PlayerAction.bhv_neck_body_to_point:type_name -> protos.Bhv_NeckBodyToPoint
	76,  // 177: protos.PlayerAction.bhv_scan_field:type_name -> protos.Bhv_ScanField
	77,  // 178: protos.PlayerAction.body_advance_ball:type_name -> protos.Body_AdvanceBall
	78,  // 179: protos.PlayerAction.body_clear_ball:type_name -> protos.Body_ClearBall
	79,  // 180: protos.PlayerAction.body_dribble:type_name -> protos.Body_Dribble
	80,  // 181: protos.PlayerAction.body_go_to_point_dodge:type_name -> protos.Body_GoToPointDodge
	81,  // 182: protos.PlayerAction.body_hold_ball:type_name -> protos.Body_HoldBall
	82,  // 183: protos.PlayerAction.body_intercept:type_name -> protos.Body_Intercept
	83,  // 184: protos.PlayerAction.body_kick_one_step:type_name -> protos.Body_KickOneStep
	84,  // 185: protos.PlayerAction.body_stop_ball:type_name -> protos.Body_StopBall
	85,  // 186: protos.PlayerAction.body_stop_dash:type_name -> protos.Body_StopDash
	86,  // 187: protos.PlayerAction.body_tackle_to_point:type_name -> protos.Body_TackleToPoint
	87,  // 188: protos.PlayerAction.body_turn_to_angle:type_name -> protos.Body_TurnToAngle
	88,  // 189: protos.PlayerAction.body_turn_to_ball:type_name -> protos.Body_TurnToBall
	89,  // 190: protos.PlayerAction.body_turn_to_point:type_name -> protos.Body_TurnToPoint
	90,  // 191: protos.PlayerAction.focus_move_to_point:type_name -> protos.Focus_MoveToPoint
	91,  // 192: protos.PlayerAction.focus_reset:type_name -> protos.Focus_Reset
	92,  // 193: protos.PlayerAction.neck_scan_field:type_name -> protos.Neck_ScanField
	93,  // 194: protos.PlayerAction.neck_scan_players:type_name -> protos.Neck_ScanPlayers
	94,  // 195: protos.PlayerAction.neck_turn_to_ball_and_player:type_name -> protos.Neck_TurnToBallAndPlayer
	95,  // 196: protos.PlayerAction.neck_turn_to_ball_or_scan:type_name -> protos.Neck_TurnToBallOrScan
	96,  // 197: protos.PlayerAction.neck_turn_to_ball:type_name -> protos.Neck_TurnToBall
	97,  // 198: protos.PlayerAction.neck_turn_to_goalie_or_scan:type_name -> protos.Neck_TurnToGoalieOrScan
	98,  // 199: protos.PlayerAction.neck_turn_to_low_conf_teammate:type_name -> protos.Neck_TurnToLowConfTeammate
	99,  // 200: protos.PlayerAction.neck_turn_to_player_or_scan:type_name -> protos.Neck_TurnToPlayerOrScan
	100, // 201: protos.PlayerAction.neck_turn_to_point:type_name -> protos.Neck_TurnToPoint
	101, // 202: protos.PlayerAction.neck_turn_to_relative:type_name -> protos.Neck_TurnToRelative
	102, // 203: protos.PlayerAction.view_change_width:type_name -> protos.View_ChangeWidth
	103, // 204: protos.PlayerAction.view_normal:type_name -> protos.View_Normal
	104, // 205: protos.PlayerAction.view_synch:type_name -> protos.View_Synch
	105, // 206: protos.PlayerAction.view_wide:type_name -> protos.View_Wide
	106, // 207: protos.PlayerAction.helios_goalie:type_name -> protos.HeliosGoalie
	107, // 208: protos.PlayerAction.helios_goalie_move:type_name -> protos.HeliosGoalieMove
	108, // 209: protos.PlayerAction.helios_goalie_kick:type_name -> protos.HeliosGoalieKick
	109, // 210: protos.PlayerAction.helios_shoot:type_name -> protos.HeliosShoot
	110, // 211: protos.PlayerAction.helios_offensive_planner:type_name -> protos.HeliosOffensivePlanner
	120, // 212: protos.PlayerAction.helios_basic_offensive:type_name -> protos.HeliosBasicOffensive
	121, // 213: protos.PlayerAction.helios_basic_move:type_name -> protos.HeliosBasicMove
	122, // 214: protos.PlayerAction.helios_set_play:type_name -> protos.HeliosSetPlay
	123, // 215: protos.PlayerAction.helios_penalty:type_name -> protos.HeliosPenalty
	124, // 216: protos.PlayerAction.helios_communication:type_name -> protos.HeliosCommunicaion
	125, // 217: protos.PlayerAction.bhv_do_force_kick:type_name -> protos.bhv_doForceKick
	126, // 218: protos.PlayerAction.bhv_do_heard_pass_recieve:type_name -> protos.bhv_doHeardPassRecieve
	127, // 219: protos.PlayerActions.actions:type_name -> protos.PlayerAction
	129, // 220: protos.CoachAction.change_player_types:type_name -> protos.ChangePlayerType
	130, // 221: protos.CoachAction.do_helios_substitute:type_name -> protos.DoHeliosSubstitute
	131, // 222: protos.CoachAction.do_helios_say_player_types:type_name -> protos.DoHeliosSayPlayerTypes
	132, // 223: protos.CoachActions.actions:type_name -> protos.CoachAction
	9,   // 224: protos.DoMoveBall.position:type_name -> protos.RpcVector2D
	9,   // 225: protos.DoMoveBall.velocity:type_name -> protos.RpcVector2D
	9,   // 226: protos.DoMovePlayer.position:type_name -> protos.RpcVector2D
	6,   // 227: protos.DoChangeMode.game_mode_type:type_name -> protos.GameModeType
	2,   // 228: protos.DoChangeMode.side:type_name -> protos.Side
	134, // 229: protos.TrainerAction.do_kick_off:type_name -> protos.DoKickOff
	135, // 230: protos.TrainerAction.do_move_ball:type_name -> protos.DoMoveBall
	136, // 231: protos.TrainerAction.do_move_player:type_name -> protos.DoMovePlayer
	137, // 232: protos.TrainerAction.do_recover:type_name -> protos.DoRecover
	138, // 233: protos.TrainerAction.do_change_mode:type_name -> protos.DoChangeMode
	139, // 234: protos.TrainerAction.do_change_player_type:type_name -> protos.DoChangePlayerType
	140, // 235: protos.TrainerActions.actions:type_name -> protos.TrainerAction
	11,  // 236: protos.ServerParam.register_response:type_name -> protos.RegisterResponse
	11,  // 237: protos.PlayerParam.register_response:type_name -> protos.RegisterResponse
	11,  // 238: protos.PlayerType.register_response:type_name -> protos.RegisterResponse
	8,   // 239: protos.RpcCooperativeAction.category:type_name -> protos.RpcActionCategory
	9,   // 240: protos.RpcCooperativeAction.target_point:type_name -> protos.RpcVector2D
	9,   // 241: protos.RpcPredictState.ball_position:type_name -> protos.RpcVector2D
	9,   // 242: protos.RpcPredictState.ball_velocity:type_name -> protos.RpcVector2D
	145, // 243: protos.RpcActionState.action:type_name -> protos.RpcCooperativeAction
	146, // 244: protos.RpcActionState.predict_state:type_name -> protos.RpcPredictState
	11,  // 245: protos.BestPlannerActionRequest.register_response:type_name -> protos.RegisterResponse
	155, // 246: protos.BestPlannerActionRequest.pairs:type_name -> protos.BestPlannerActionRequest.PairsEntry
	19,  // 247: protos.BestPlannerActionRequest.state:type_name -> protos.State
	14,  // 248: protos.WorldModel.OurPlayersDictEntry.value:type_name -> protos.Player
	14,  // 249: protos.WorldModel.TheirPlayersDictEntry.value:type_name -> protos.Player
	9,   // 250: protos.WorldModel.HeliosHomePositionsEntry.value:type_name -> protos.RpcVector2D
	147, // 251: protos.BestPlannerActionRequest.PairsEntry.value:type_name -> protos.RpcActionState
	19,  // 252: protos.Game.GetPlayerActions:input_type -> protos.State
	19,  // 253: protos.Game.GetCoachActions:input_type -> protos.State
	19,  // 254: protos.Game.GetTrainerActions:input_type -> protos.State
	20,  // 255: protos.Game.SendInitMessage:input_type -> protos.InitMessage
	142, // 256: protos.Game.SendServerParams:input_type -> protos.ServerParam
	143, // 257: protos.Game.SendPlayerParams:input_type -> protos.PlayerParam
	144, // 258: protos.Game.SendPlayerType:input_type -> protos.PlayerType
	10,  // 259: protos.Game.Register:input_type -> protos.RegisterRequest
	11,  // 260: protos.Game.SendByeCommand:input_type -> protos.RegisterResponse
	148, // 261: protos.Game.GetBestPlannerAction:input_type -> protos.BestPlannerActionRequest
	128, // 262: protos.Game.GetPlayerActions:output_type -> protos.PlayerActions
	133, // 263: protos.Game.GetCoachActions:output_type -> protos.CoachActions
	141, // 264: protos.Game.GetTrainerActions:output_type -> protos.TrainerActions
	150, // 265: protos.Game.SendInitMessage:output_type -> protos.Empty
	150, // 266: protos.Game.SendServerParams:output_type -> protos.Empty
	150, // 267: protos.Game.SendPlayerParams:output_type -> protos.Empty
	150, // 268: protos.Game.SendPlayerType:output_type -> protos.Empty
	11,  // 269: protos.Game.Register:output_type -> protos.RegisterResponse
	150, // 270: protos.Game.SendByeCommand:output_type -> protos.Empty
	149, // 271: protos.Game.GetBestPlannerAction:output_type -> protos.BestPlannerActionResponse
	262, // [262:272] is the sub-list for method output_type
	252, // [252:262] is the sub-list for method input_type
...
func file_service_proto_init() {
	...
	file_service_proto_msgTypes[123].OneofWrappers = []any{
